...
class VideoPlayerControls extends Component {
	...
	renderScale = () => {
		let inputFloats = []
		// Get data form ML model
		const response = fetch('https://ulaxwjmei9.execute-api.ap-southeast-2.amazonaws.com/default/codebrew-model/predict', {
			method: 'GET',
			headers: {
